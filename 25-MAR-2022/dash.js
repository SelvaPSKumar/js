    ...
    dropDown.addEventListener('change', (evvent) => {
      const result = document.querySelector('.result');
      result.idFilter = `${evvent.target.id}`;
    });
    ...
    var activeSts = document.getElementById("active_status");
    var deleteSts = document.getElementById("delete_status");
    var idNum = document.getElementById("id");
    var datTym = document.getElementById("createdAt");
    var updateAt = document.getElementById("updatedAt");
    

    // Fetch Category List End GET
    
    // Table Show to List Note GET
    ...
    // var dataTym = document.getElementById("delete_status");
    // var Notes = document.getElementById("id");
    // var idNum = document.getElementById("createdAt");
    // var CategoryId = document.getElementById("updatedAt");
